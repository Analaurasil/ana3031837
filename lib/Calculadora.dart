            ...
            Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: Color.fromRGBO(195, 210, 215, 1), // Cor de fundo dentro da borda
                ),
                child: Container(
                  decoration: BoxDecoration(
                    border: Border.all(
                    ...
                    color: Color.fromARGB(255, 197, 214, 240), // Cor de fundo dentro da segunda borda
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(8.0), // Ajuste o espaçamento interno conforme necessário
                   // child: Center(
